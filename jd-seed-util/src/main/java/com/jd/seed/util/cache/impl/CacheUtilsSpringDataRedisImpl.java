...
public class CacheUtilsSpringDataRedisImpl implements CacheUtils {
	...
	public boolean setEx(String key, String value, long seconds) {
		...
		try {
			...
			SPRING_DATA_REDIS_LOG.error(
					"springDataRedis-->setEx failure key:" + key + ",value:" + value + ",seconds:" + seconds, ex);
		}
		return false;
	}
	...
	public boolean setEx(String key, Object value, long seconds) {
		...
		try {
			...
			SPRING_DATA_REDIS_LOG.error(
					"springDataRedis-->setEx Object failure key:" + key + ",value:" + value + ",seconds:" + seconds,
					ex);
		}
		return false;
	}
	...
	public boolean hSet(String key, String field, Object value) {
		...
		try {
			...
			SPRING_DATA_REDIS_LOG.error(
					"springDataRedis-->hSet Object failure key:" + key + ",field:" + field + ",value:" + value, ex);
		}
		return false;
	}
	...
	public <T> T hGet(String key, String field, Class<T> clazz) {
		...
		try {
			...
			SPRING_DATA_REDIS_LOG.error(
					"springDataRedis--><T> T hGet failure key:" + key + ",field:" + field + ",class:" + clazz, ex);
		}
		return null;
	}
	...
	public <T> T lPop(String key, Class<T> clazz) {
		...
		if (StringUtils.isBlank(stringValue)) {
			SPRING_DATA_REDIS_LOG
					.warn("springDataRedis--> lPop failure key:" + key + ",class:" + clazz + ",return null");
			return null;
		}
		try {
			return JSON.parseObject(stringValue, clazz);
		} catch (Exception ex) {
			SPRING_DATA_REDIS_LOG.error("springDataRedis--> lPop failure key:" + key + ",class:" + clazz, ex);
		}
		return null;
	}
	...
	public <T> T rPop(String key, Class<T> clazz) {
		...
		if (StringUtils.isBlank(stringValue)) {
			SPRING_DATA_REDIS_LOG
					.warn("springDataRedis--> rPop failure key:" + key + ",class:" + clazz + ",return null");
			return null;
		}
		try {
			return JSON.parseObject(stringValue, clazz);
